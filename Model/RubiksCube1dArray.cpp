//
// Created by Yogesh Paneru on 27-06-2025.
//
#include "GenericRubiksClass.h"
class RubiksCube1dArray : public GenericRubiksClass {
private:
    /*
...
public:
    ...
    GenericRubiksClass &uPrime() override {
        this->u();
        this->u();
        this->u();
    ...
    GenericRubiksClass &u2() override {
        this->u();
        this->u();
    ...
    GenericRubiksClass &lPrime() override {
        this->l();
        this->l();
        this->l();
    ...
    GenericRubiksClass &l2() override {
        this->l();
        this->l();
    ...
    GenericRubiksClass &fPrime() override {
        this->f();
        this->f();
        this->f();
    ...
    GenericRubiksClass &f2() override {
        this->f();
        this->f();
    ...
    GenericRubiksClass &rPrime() override {
        this->r();
        this->r();
        this->r();
    ...
    GenericRubiksClass &r2() override {
        this->r();
        this->r();
    ...
    GenericRubiksClass &bPrime() override {
        this->b();
        this->b();
        this->b();
    ...
    GenericRubiksClass &b2() override {
        this->b();
        this->b();
    ...
    GenericRubiksClass &dPrime() override {
        this->d();
        this->d();
        this->d();
    ...
    GenericRubiksClass &d2() override {
        this->d();
        this->d();
